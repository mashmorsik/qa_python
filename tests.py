...
class TestBooksCollector:
    ...
    def test_add_new_book_same_title_doesnt_add(self):
        collector = BooksCollector()
        collector.add_new_book('Гарри Поттер и Тайная Комната')
        collector.add_new_book('Гарри Поттер и Тайная Комната')
        assert len(collector.books_rating) == 1

    def test_set_book_rating_less_than_11_changes_to_new(self):
        collector = BooksCollector()
    ...
    def test_set_book_rating_more_than_10_stays_the_same(self):
        collector = BooksCollector()
    ...
    def test_set_book_rating_0_stays_the_same(self):
        collector = BooksCollector()
    ...
    def test_get_books_with_specific_rating_two_books_return_one(self):
        collector = BooksCollector()
    ...
    def test_get_books_with_specific_rating_no_books_with_wanted_rating(self):
        collector = BooksCollector()
        collector.add_new_book('Гарри Поттер и Дары Смерти')
        collector.set_book_rating('Гарри Поттер и Дары Смерти', 8)
        collector.add_new_book('Гарри Поттер и Проклятое Дитя')
    ...
    def test_add_book_in_favorites_same_title_doesnt_add(self):
        collector = BooksCollector()
        collector.add_new_book('Гарри Поттер и Узник Азкабана')
        collector.add_new_book('Гарри Поттер и Узник Азкабана')
        collector.add_book_in_favorites('Гарри Поттер и Узник Азкабана')
    ...
    def test_add_book_in_favorites_not_in_books_collector(self):
        collector = BooksCollector()
        collector.add_book_in_favorites('Гарри Поттер и Узник Азкабана')
